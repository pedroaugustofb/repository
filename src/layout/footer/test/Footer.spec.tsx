...
describe("footer test", () => {
    ...
    const TextOptions = (ptText: string, engText: string) => localStorage.getItem('language') === 'PT-BR' ? ptText : engText;
    ...
    it("should render correctly", () => {
        ...
        const DownloadButton = screen.getByText(TextOptions("Baixar Currículo" , "Download Cv"), {exact: false})

        /** @NavigationButtons */
        const HomeButton = screen.getByText(TextOptions("Início" , "Home"))
        const PortfolioButton = screen.getByText(TextOptions("Portfólio" , "Portfolio"))
    ...
    it.each([
        ...
        ("should %s button navigate with correct params.", (textPt, textEng, path) => {
