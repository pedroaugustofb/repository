      ...
      >
        <Style.TextContainer flex width="40%" height="80%" center>
          <Style.IconsContainer width="20%" height="100%" flex center>
            ...
            <LinkedIcon
              href="https://www.linkedin.com/in/pedrofoltram/"
              font="1.8rem"
            >
              <AiFillLinkedin style={{ color: "#14261C" }} />
            </LinkedIcon>
            <LinkedIcon
              href="https://www.instagram.com/pedrofoltram/"
              font="1.8rem"
            >
          ...
          <Style.WelcomeContainer width="80%" height="100%" flex center column>
            <Style.TitleArea>
              <Style.WelcomeTitle>
                {language === "PT-BR"
                  ? TextJson["Welcome Title(PT-BR)"]
                  : TextJson["Welcome Title(ENG)"]}
              </Style.WelcomeTitle>
            </Style.TitleArea>
            <Style.TextArea margin="0 0  2rem 0">
              <Style.WelcomeText>
                {language === "PT-BR"
                  ? TextJson["Welcome Text(PT-BR)"]
                  : TextJson["Welcome Text(ENG)"]}
              </Style.WelcomeText>
            </Style.TextArea>
            <Style.WelcomeButtonsContainer width="100%" height="100px">
              ...
              <DefaultButton
                ...
                onClick={() =>
                  window.open(
                    "https://drive.google.com/file/d/1xaWvCGtUdSBY9mEIh42KlGZAie7WFlKH/view?usp=share_link"
                  )
                }
              >
      ...
      >
        <Container flex center width="60%">
          <Style.TitleAboutContainer flex center column>
            ...
            >
              {language === "PT-BR"
                ? TextJson["About Title(PT-BR)"]
                : TextJson["About Title(ENG)"]}
            </Style.AboutTitle>
            <Style.TitleLine />
        ...
        <Style.AboutMeContentContainer>
          ...
          <Style.AboutMeTextsContainer>
            <Container
              flex
              width="100%"
              style={{ textAlign: "left", maxWidth: "461px" }}
            >
              <Title
                color="#14261C"
                fontSize="25px"
            ...
            >
              <Style.WelcomeText>
                {language === "PT-BR"
                  ? TextJson["About me Text(PT-BR)"]
                  : TextJson["About me Text(ENG)"]}
              </Style.WelcomeText>
            </Style.TextArea>
            <Container
              flex
            ...
            <Style.WelcomeButtonsContainer>
              <DefaultButton medium ghost borderColor="#14261C" margin="1rem">
                <Link
                  to="/portfolio"
                  style={{ color: "#14261C", textDecoration: "none" }}
                >
